...
const generateTheme = palette => {
  ...
  const defaultTheme: any = {
    ...
    inputPlaceholderColorActive: chromaPalette.Neutral40,
    inputBgHover: chromaPalette.Neutral20,
    inputBgActive: chromaPalette.Neutral0,
    inputBgFocus: chromaPalette.Neutral0,
    inputBgDisabled: chromaPalette.Neutral50,
    inputFocusBorderColor: chromaPalette.Azure80,
    inputHoverBorderColor: chromaPalette.Neutral40,
    inputSuccessBorder: chromaPalette.Green80,
    inputWarningBorder: chromaPalette.Yellow80,
    inputErrorBorder: chromaPalette.Crimson80,
    inputSelectionBg: chromaPalette.Sapphire10,
    inputLabelColor: chromaPalette.Neutral50,
    inputNotificationColor: chromaPalette.Neutral45,
