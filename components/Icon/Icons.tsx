...
export const customH1 = ({
  ...
  <svg
    ...
    <path d="M3.48364 18V6.36363H5.5916V11.2898H10.9836V6.36363H13.0973V18H10.9836V13.0568H5.5916V18H3.48364Z" />
    <path d="M19.7308 6.36363V18H17.6172V9.05681H17.5206C17.4069 9.23484 17.1418 9.42424 16.7251 9.625C16.3085 9.82197 15.7725 9.92045 15.1172 9.92045V8.21591C15.5187 8.21591 15.8766 8.14583 16.191 8.00568C16.5054 7.86174 16.7725 7.6875 16.9922 7.48295C17.2157 7.27462 17.388 7.06818 17.5092 6.86363C17.6304 6.65909 17.6967 6.49242 17.7081 6.36363H19.7308Z" />
  </svg>
)
...
export const customH2 = ({
  ...
  <svg
    ...
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg">
    <path d="M2.22583 18V6.36364H4.33378V11.2898H9.72583V6.36364H11.8395V18H9.72583V13.0568H4.33378V18H2.22583Z" />
    <path d="M14.0184 18V16.4773L18.0582 12.517C18.634 11.9337 19.0677 11.4375 19.3594 11.0284C19.651 10.6193 19.7969 10.1723 19.7969 9.6875C19.7969 9.13826 19.6131 8.70644 19.2457 8.39204C18.8783 8.07386 18.4181 7.91477 17.865 7.91477C17.2855 7.91477 16.8215 8.08901 16.473 8.4375C16.1283 8.7822 15.9559 9.25189 15.9559 9.84659H13.9503C13.9503 9.10795 14.1188 8.46591 14.4559 7.92045C14.7931 7.375 15.2571 6.95265 15.848 6.65341C16.4427 6.35417 17.1245 6.20454 17.8934 6.20454C18.6737 6.20454 19.3575 6.35038 19.9446 6.64204C20.5355 6.93371 20.9957 7.33333 21.3253 7.84091C21.6548 8.34848 21.8196 8.92803 21.8196 9.57954C21.8196 10.0152 21.7362 10.4432 21.5696 10.8636C21.4029 11.2841 21.1094 11.7519 20.6889 12.267C20.2722 12.7784 19.687 13.3958 18.9332 14.1193L16.9275 16.1591V16.2386H21.9957V18H14.0184Z" />
  </svg>
)

export const customOFormatColorFill = ({
  height = "24px",
  width = "24px",
  fill = "#000",
}: IconType) => (
  <svg
    ...
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg">
    <path d="M16.5601 8.94L7.62006 0L6.21006 1.41L8.59006 3.79L3.44006 8.94C2.85006 9.53 2.85006 10.48 3.44006 11.06L8.94006 16.56C9.23006 16.85 9.62006 17 10.0001 17C10.3801 17 10.7701 16.85 11.0601 16.56L16.5601 11.06C17.1501 10.48 17.1501 9.53 16.5601 8.94V8.94ZM5.21006 10L10.0001 5.21L14.7901 10H5.21006ZM19.0001 11.5C19.0001 11.5 17.0001 13.67 17.0001 15C17.0001 16.1 17.9001 17 19.0001 17C20.1001 17 21.0001 16.1 21.0001 15C21.0001 13.67 19.0001 11.5 19.0001 11.5Z" />
    <path d="M0 20H24V24H0V20Z" fill="#E7D9F2" />
  </svg>
)

export const customOFormatColorText = ({
  height = "24px",
  width = "24px",
  fill = "#000",
}: IconType) => (
  <svg
    ...
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg">
    <path d="M0 20H24V24H0V20Z" fill="#FFC700" />
    <path d="M11 3L5.5 17H7.75L8.87 14H15.12L16.24 17H18.49L13 3H11ZM9.62 12L12 5.67L14.38 12H9.62V12Z" />
  </svg>
)
